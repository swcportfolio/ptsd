...
/// IES-R-K Message Item Widget
// ignore: must_be_immutable
class ChatMessageItemIESRK extends StatefulWidget {
  ...
  ChatMessageItemIESRK({required this.chatData,required this.animationController,  this.callback,  this.isSelectColor,  this.runOnce});

  @override
  _ChatMessageItemIESRKState createState() => _ChatMessageItemIESRKState();
}

class _ChatMessageItemIESRKState extends State<ChatMessageItemIESRK> {
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: 45.0, height: 45.0,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(widget.chatData.message.toString(), textScaleFactor: 0.9, style: TextStyle(color: Colors.white)),
                          ...
                          FittedBox(
                            child: Container(
                                ...
                                child: SizedBox(
                                    ...
                                    height:
                                    widget.chatData.chatAnswersListIESRK!.length == 5 ? 260 :
                                    widget.chatData.chatAnswersListIESRK!.length == 3 ? 210 : 110,
                                    child: GridView.builder(
                                        shrinkWrap: true,
                                        physics: const NeverScrollableScrollPhysics(),
                                        itemCount: widget.chatData.chatAnswersListIESRK!.length,
  ...
  /// IES-R-K Gridview 선택지
  Widget buildGridViewSelect (int index) {
    List<String> selectionText = ['전혀 아니에요', '약간 그런것 같아요', '일반적으로 그런 편이에요', '꽤 그런것 같아요', '매우 그런것 같아요'];
    return GestureDetector(
        onTap: ()
        {
          ChatSelect select = ChatSelect(
              questionNo:int.parse(widget.chatData.questionNo!),
              answerNo:widget.chatData.chatAnswersListIESRK![index].answerNo,
              answerMessage:selectionText[index]
          );
        ...
        child:GridViewItem.buildChatGridViewItem(selectionText[index], widget.isSelectColor![index])
    );
  }

  /// IES-R-K 종료 메시지인지 확인
  isEndByMessage() {
    return widget.chatData.message == '검사가 종료되었습니다 수고하셨습니다.' || widget.chatData.message == '검사를 종료합니다. 결과를 생성하고 있습니다. 잠시만 기다려 주세요' ? true : false;
  }
}
